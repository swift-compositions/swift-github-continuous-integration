...
extension GitHub.ContinuousIntegration.Workflow.YAML {
...
extension GitHub.ContinuousIntegration.Workflow.YAML.Node {
    ...
    public var mapping: GitHub.ContinuousIntegration.Workflow.YAML.Mapping? {
