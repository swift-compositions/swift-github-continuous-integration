...
extension GitHub.ContinuousIntegration.Validation {
    ...
    public struct HardenRunner: Validator {
        ...
        static func isRouting(_ job: GitHub.ContinuousIntegration.Workflow.Job) -> Bool {
        ...
        static func absentMessage(document: String, job: String, uses: String) -> String {
            """
            \(document): job \(GitHub.ContinuousIntegration.Workflow.YAML.Node.repr(job)) first step is not \
        ...
        static func unpinnedMessage(document: String, job: String, uses: String) -> String {
            """
            \(document): job \(GitHub.ContinuousIntegration.Workflow.YAML.Node.repr(job)) harden-runner not \
