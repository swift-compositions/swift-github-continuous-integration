...
extension GitHub.ContinuousIntegration.Validation.Drift {
    ...
    public struct LintValidatorsWeekly: GitHub.ContinuousIntegration.Validation.Validator {
        ...
        public func findings(
            in subject: GitHub.ContinuousIntegration.Validation.Subject
        ) throws(GitHub.ContinuousIntegration.Validation.EnvironmentDefect) -> [Finding] {
        ...
        public static func gaps(
            in document: GitHub.ContinuousIntegration.Workflow.YAML.Node
        ) throws(GitHub.ContinuousIntegration.Validation.EnvironmentDefect) -> [Gap] {
...
extension GitHub.ContinuousIntegration.Validation.Drift.LintValidatorsWeekly {
